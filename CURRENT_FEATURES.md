...
- **リリース状態（現況・2026-06-26〜）**: **Claude Mythos 5 = 🔮 100+ 米国機関（Glasswing + 連邦機関）への限定再開フェーズ**（6/26 輸出規制部分解除、実展開タイムライン未公表） / **Claude Fable 5〔公開版〕= ⛔ 停止継続**（書簡で言及なし）
