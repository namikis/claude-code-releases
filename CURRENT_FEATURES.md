...
- **リリース状態**: **Claude Fable 5 = ✅ GA**（2026-06-09、Mythos クラスの公開版） / **Claude Mythos 5 = 🔬 限定提供**（Project Glasswing パートナー + 選定された生物学研究者の trusted access）
