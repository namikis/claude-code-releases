...
- **確度**: ❓ 噂・未確認（5/23 testingcatalog リーク → **5/25 BleepingComputer 報道で確度補強**。ただし **5/22 公式 Glasswing アップデートの「general release 意向」と方向性は整合**）
- **情報源**: [BleepingComputer（5/25）](https://www.bleepingcomputer.com/news/artificial-intelligence/anthropics-restricted-claude-mythos-model-may-be-coming-to-claude-code/) / [testingcatalog（5/23）](https://www.testingcatalog.com/anthropic-prepares-mythos-1-for-claude-code-and-claude-security/) / [Anthropic Research - Glasswing initial update（5/22 公式）](https://www.anthropic.com/research/glasswing-initial-update)
