...
- **リリース状態**: ✅ GA（Excel / Word / PowerPoint）/ 🧪 ベータ（Outlook、**2026-05-05 launch**）。**2026-05-05 で「Microsoft 365 完全統合体験」として正式 GA 化**（個別 add-in に加え、アプリ間コンテキスト自動キャリーオーバー込みの統合 UX として）
...
- **Outlook Add-in 🧪 ベータ**（2026-05-05 launch）: メール本文の要約・返信草稿生成、添付分析、他 M365 アプリへの自動コンテキスト橋渡し（メール内容を即 Excel / PowerPoint へキャリーオーバー）。Beta 期間中の制限事項は Help Center 参照
