...
| `/clear` | 会話履歴クリア |
| `/compact` | 会話コンパクト化 |
| `/config` | 設定画面。**`/config key=value` 構文で任意設定をプロンプトから直接変更可能**（例 `/config thinking=false`、interactive / `-p` / Remote Control 全対応、v2.1.181） |
...
### Claude Fable 5 / Mythos 5 「48 時間以内に復旧」説 ❓
- **確度**: ❓ 噂・未確認 — 2026-06-16 に第三者アカウント **BridgeMind** が「Fable 5 は 48 時間以内に復旧」と SNS で予測。**Anthropic の公式アナウンスではない**。
...
- **情報源**: [pasqualepillitteri.it](https://pasqualepillitteri.it/en/news/5180/claude-fable-5-when-will-it-return) / [Polymarket](https://polymarket.com/event/claude-fable-5-restored-for-us-customers-by-20260613193753196)
- **最終確認日**: 2026-06-18
